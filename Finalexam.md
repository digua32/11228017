...
本文件提供拉普拉斯轉換作業第 (5) 題與傅立葉級數作業第 (7) 題的詳細求解步驟。
...
### Step 1：拆解
\[
\mathcal{L}^{-1} \left\{ \frac{1}{s(s+4)} \right\}
-
...
令：
\[
F(s) = \frac{1}{s(s+4)}, \quad f(t) = \mathcal{L}^{-1}\{F(s)\}
\]
...
因此：
\[
F(s) = \frac{1}{4}\frac{1}{s} - \frac{1}{4}\frac{1}{s+4}
\]
